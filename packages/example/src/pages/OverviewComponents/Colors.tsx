        ...
        <Grid container spacing={3}>
            ...
            <Grid item xs={12} sm={6} md={4}>
                <MainCard title="Secondary Color">
                    <Stack>
                        <ColorBox bgcolor="secondary.lighter" data={{ label: "Grey-1", color: secondary.lighter }} title="secondary.lighter" dark />
                        ...
                        <ColorBox bgcolor="secondary.400" data={{ label: "Grey-5", color: secondary[400] }} title="secondary[400]" dark />
                        <ColorBox bgcolor="secondary.main" data={{ label: "Grey-6", color: secondary.main }} title="secondary.main" main />
                        <ColorBox bgcolor="secondary.600" data={{ label: "Grey-7", color: secondary[600] }} title="secondary[600]" />
                        <ColorBox bgcolor="secondary.dark" data={{ label: "Grey-8", color: secondary.darker }} title="secondary.dark" />
            ...
            <Grid item xs={12} sm={6} md={4}>
                <MainCard title="Other Color">
                    <Stack>
                        <ColorBox bgcolor="secondary.A100" data={{ label: "Grey-A1", color: secondary.A100 }} title="secondary.A100" dark />
                        <ColorBox bgcolor="secondary.A200" data={{ label: "Grey-A2", color: secondary.A200 }} title="secondary.A200" />
                        <ColorBox bgcolor="secondary.A300" data={{ label: "Grey-A3", color: secondary.A300 }} title="secondary.A300" />
                    </Stack>
                </MainCard>
            </Grid>
            <Grid item xs={12} sm={6} md={4}>
            ...
            <Grid item xs={12} sm={6} md={4}>
                <MainCard title="Info Color">
                    <Stack>
                        <ColorBox bgcolor="info.lighter" data={{ label: "Cyan-1", color: info.lighter }} title="info.lighter" dark />
                        <ColorBox bgcolor="info.light" data={{ label: "Cyan-4", color: info.light }} title="info.light" dark />
                        <ColorBox bgcolor="info.main" data={{ label: "Cyan-6", color: info.main }} title="info.main" main />
                        <ColorBox bgcolor="info.dark" data={{ label: "Cyan-8", color: info.dark }} title="info.dark" />
                        <ColorBox bgcolor="info.darker" data={{ label: "Cyan-10", color: info.darker }} title="info.darker" />
                    </Stack>
                </MainCard>
            </Grid>
        </Grid>
