...
const MiniLogo: React.FC<Props> = () => {
    ...
    return (
         ...
         */
        <>
            <svg width="118" height="35" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                ...
                />
                <path d="M7.35025 17.5L9.1228 15.7275L9.5697 15.2805L7.83937 13.5496H6.95039L6.94798 13.552L4.63564 15.8644L6.8551 18.073L7.35025 17.5Z" fill="url(#paint0_linear)" />
                <path
